...
public class Reo3 extends JFrame {
	...
	public Reo3() {
		...
		btnHome.setFont(new Font("±¼¸²", Font.PLAIN, 13));
		btnHome.setBounds(485, 10, 56, 40);
		contentPane.add(btnHome);
		
		JLabel lbldno = new JLabel("ÀçÁ¤ºÎ °³Æí");
		...
		panel.setBounds(218, 69, 294, 243);
		contentPane.add(panel);
		
		JLabel Team1 = new JLabel("1\uD300");
